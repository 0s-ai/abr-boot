package org.jeecg.modules.abr.aiHostFile.vo;
 ...
 */
@Data
@ApiModel(value="ai_host_filePage对象", description="主机文件")
public class AiHostFilePage {
	...
	@ExcelCollection(name="主机历史文件")
	@ApiModelProperty(value = "主机历史文件")
	private List<AiHostFlhis> aiHostFlhisList;
