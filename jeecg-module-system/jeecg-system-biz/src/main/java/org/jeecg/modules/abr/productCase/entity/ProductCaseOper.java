 ...
 * @Version: V1.0
 */
@ApiModel(value="product_case_oper对象", description="方案操作")
@Data
@TableName("product_case_oper")
public class ProductCaseOper implements Serializable {
	...
	/**执行角色*/
	@Excel(name = "执行角色", width = 15)
    @ApiModelProperty(value = "执行角色")
    private java.lang.String doRole;
	/**执行类型*/
