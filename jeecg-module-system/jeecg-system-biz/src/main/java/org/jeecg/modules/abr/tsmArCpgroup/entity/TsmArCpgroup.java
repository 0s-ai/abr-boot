package org.jeecg.modules.abr.tsmArCpgroup.entity;
 ...
 */
@Data
@TableName("tsm_ar_cpgroup")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="tsm_ar_cpgroup对象", description="归档副本组")
public class TsmArCpgroup implements Serializable {
    ...
    private java.lang.String retver;
	/**同步标记*/
