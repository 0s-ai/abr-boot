  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="保留天数" v-bind="validateInfos.retver">
            <a-input v-model:value="formData.retver" placeholder="请输入保留天数" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../TsmArCpgroup.api';
