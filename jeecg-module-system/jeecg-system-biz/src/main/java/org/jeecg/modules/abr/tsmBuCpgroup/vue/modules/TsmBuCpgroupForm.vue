    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="备份副本组名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="name">
              <a-input v-model="model.name" placeholder="请输入备份副本组名称"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="保留版本数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="verexists">
              <a-input v-model="model.verexists" placeholder="请输入保留版本数"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="删除对象保留版本数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="verdeleted">
              <a-input v-model="model.verdeleted" placeholder="请输入删除对象保留版本数"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="保留天数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="retextra">
              <a-input v-model="model.retextra" placeholder="请输入保留天数"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="保留唯一版本天数" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="retonly">
              <a-input v-model="model.retonly" placeholder="请输入保留唯一版本天数"  ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/tsmBuCpgroup/tsmBuCpgroup/add",
          edit: "/tsmBuCpgroup/tsmBuCpgroup/edit",
          queryById: "/tsmBuCpgroup/tsmBuCpgroup/queryById"
        }
      }
    },
    computed: {
