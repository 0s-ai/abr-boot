  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="策略域" v-bind="validateInfos.name">
            <a-input v-model:value="formData.name" placeholder="请输入策略域" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
      </a-row>
    </a-form>
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../TsmDomains.api';
  ...
  const validatorRules = {
    ...
    name: [{ required: true, message: '请输入策略域!'},],
  };
