package org.jeecg.modules.abr.tsmMgmt.entity;
...
@ApiModel(value="tsm_mgmt对象", description="管理类")
public class TsmMgmt implements Serializable {
	...
	/**类名称*/
	@Excel(name = "类名称", width = 15)
    @ApiModelProperty(value = "类名称")
    private java.lang.String className;
	/**是否默认管理类*/
	@Excel(name = "是否默认管理类", width = 15)
    @ApiModelProperty(value = "是否默认管理类")
    private java.lang.String defaultmc;
	/**描述*/
