      ...
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="类名称" v-bind="validateInfos.className">
            <a-input v-model:value="formData.className" placeholder="请输入类名称" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="是否默认管理类" v-bind="validateInfos.defaultmc">
            <a-input v-model:value="formData.defaultmc" placeholder="请输入是否默认管理类" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../TsmMgmt.api';
