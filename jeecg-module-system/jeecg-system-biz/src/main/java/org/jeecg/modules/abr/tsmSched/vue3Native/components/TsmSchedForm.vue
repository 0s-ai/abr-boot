  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="关联客户机" v-bind="validateInfos.assocNode">
	          <j-select-multiple type="list_multi" v-model:value="formData.assocNode" dictCode="tsm_nodes where del_flag=0,name,id" placeholder="请选择关联客户机" :disabled="disabled" :triggerChange="false"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
        ...
        <a-col :span="24">
          <a-form-item label="频率" v-bind="validateInfos.duration">
	          <j-dict-select-tag v-model:value="formData.duration" dictCode="duration_type" placeholder="请选择频率" disabled/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="运行脚本" v-bind="validateInfos.objects">
            <a-input v-model:value="formData.objects" placeholder="请输入运行脚本" :disabled="disabled"></a-input>
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../TsmSched.api';
  ...
  const validatorRules = {
    ...
    duration: [{ required: true, message: '请输入频率!'},],
    objects: [{ required: true, message: '请输入运行脚本!'},],
  };
